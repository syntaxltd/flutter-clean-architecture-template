...
class DialogService {
  ...
  Future<OkCancelResult> error({required String title, required String message}) {
    return showOkAlertDialog(context: _getSafeContext(), title: title, message: message);
  }
  ...
  Future<OkCancelResult> ask({required String title, required String message, required String positiveButton, required String negativeButton}) {
    return showOkCancelAlertDialog(context: _getSafeContext(), title: title, message: message, okLabel: positiveButton, cancelLabel: negativeButton);
  }
}
